...
const rawEvents: { banners: Event[]; activities: Event[] } = {
  banners: [
    ...
    },
    {
      ...
      description: "Featured 4* are; Waning Redshift, Jinzhou Keeper, Hollow Mirage.",
      startDate: "2025-01-02 04:00:00",
      endDate: "2025-01-23 09:59:59",
      isGlobal: true,
      color: "#40619e",
    ...
    },
    {
      ...
      description: "Featured 4* are; Celestial Spiral, Dauntless Evernight, Variation.",
      startDate: "2025-01-23 10:00:00",
      endDate: "2025-02-12 11:59:59",
      color: "#4d3871",
      url: "https://wutheringwaves.kurogames.com/en/main/news/detail/1864",
  ...
  activities: [
    {
      ...
      description: "Log into the game and check into claim rewards: 5*Radiant Tide and 5*Lustrous Tide.",
      startDate: "2025-01-02 04:00:00",
    ...
    },
    {
      name: "Tower of Adversity: Hazard Revisited",
      img: "https://snipboard.io/NnA3YO.jpg",
      startDate: "2025-01-06 04:00",
      endDate: "2025-01-20 04:00",
      color: "#18235f",
      reliability: "Official",
      group: EVENT_GROUP.TOWER_OF_ADVERSITY,
    },
