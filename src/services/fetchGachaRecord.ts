...
/**
 * Fetches the gacha records given the `GachaRecordQueryArgs` fetched from a user's Convene History URL fetched from the game logs.
 ...
 * @returns
 */
export default async function fetchGachaRecord(
